...
require (
	...
	github.com/xuanson2406/machine-controller-manager v1.2.5-dev4
...
require (
	...
	github.com/xuanson2406/go-vcloud-director-fptcloud/v2 v2.1.5 // indirect
	...
	k8s.io/apiextensions-apiserver v0.22.9 // indirect
