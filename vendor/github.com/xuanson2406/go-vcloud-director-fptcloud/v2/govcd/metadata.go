...
// TODO: This function is currently using XML API underneath as OpenAPI metadata is supported from v37.0 and is currently in alpha at the moment. See https://github.com/xuanson2406/go-vcloud-director-fptcloud/pull/455
...
// and waits for the task to finish.
// TODO: This function is currently using XML API underneath as OpenAPI metadata is supported from v37.0 and is currently in alpha at the moment. // TODO: This function is currently using XML underneath as metadata is supported in v37.0 and at the moment is in alpha state. See https://github.com/xuanson2406/go-vcloud-director-fptcloud/pull/455
